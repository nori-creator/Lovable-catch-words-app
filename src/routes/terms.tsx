...
function TermsEn() {
  return (
    <>
      ...
      <section className="prose prose-sm mt-6 max-w-none dark:prose-invert">
        <h2>1. Scope</h2>
        <p>These terms set out the conditions for using Catchwords (“the Service”). By using the Service you are deemed to have agreed to these terms.</p>

        <h2>2. Accounts</h2>
        <p>You are responsible for creating your account with accurate information and for keeping your credentials secure. The Service is not available to anyone under 13 years of age.</p>

        <h2>3. Content you post</h2>
        <p>You retain copyright in the photos, text and other content you post. You grant us the right to use that content to the extent necessary to provide and improve the Service.</p>

        <h2>4. Prohibited conduct</h2>
        <ul>
          <li>Posting content that infringes others' rights (portrait rights, copyright and so on)</li>
        ...
        <p>Intellectual property in the Service — including its logo, design and the format of AI-generated cards — belongs to us.</p>

        <h2>6. Disclaimer</h2>
        <p>The Service includes AI-assisted study support. We do not warrant the accuracy of generated content. Please consult a qualified professional for decisions that matter.</p>

        <h2>7. Changes and suspension</h2>
        <p>We may change or suspend the Service without prior notice.</p>

        <h2>8. Governing law and jurisdiction</h2>
        <p>These terms are governed by the laws of Japan. Any dispute shall be subject to the exclusive jurisdiction of the Tokyo District Court as the court of first instance.</p>
