...
const DICT: Record<string, { ja: string; en: string }> = {
  ...
  "cat.building": { ja: "🏛️ 建物", en: "🏛️ Buildings" },
  "cat.street": { ja: "🛣️ 街並み", en: "🛣️ Streets" },
  "cat.sign": { ja: "🪧 看板", en: "🪧 Signs" },
  "cat.shop": { ja: "🏪 お店", en: "🏪 Shops" },
  "cat.home": { ja: "🏠 家", en: "🏠 Home" },
  "cat.furniture": { ja: "🛋️ 家具", en: "🛋️ Furniture" },
  ...
  "cat.stationery": { ja: "✏️ 文房具", en: "✏️ Stationery" },
  "cat.book": { ja: "📚 本", en: "📚 Books" },
  "cat.tech": { ja: "💻 テック", en: "💻 Tech" },
  "cat.gadget": { ja: "🖱️ ガジェット", en: "🖱️ Gadgets" },
  ...
  "cat.weather": { ja: "☁️ 天気", en: "☁️ Weather" },
  "cat.sky": { ja: "☀️ 空", en: "☀️ Sky" },
  "cat.water": { ja: "💧 水", en: "💧 Water" },
  "cat.mountain": { ja: "⛰️ 山", en: "⛰️ Mountains" },
  "cat.body": { ja: "🖐️ 体の部位", en: "🖐️ Body parts" },
  "cat.face": { ja: "😊 顔", en: "😊 Face" },
  "cat.hand": { ja: "🖐️ 手", en: "🖐️ Hands" },
