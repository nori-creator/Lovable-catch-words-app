...
export const DICT: Record<string, { ja: string; en: string }> = {
  ...
  "card.newsLabel": { ja: "台湾のサイトで検索", en: "Search Taiwanese sites" },
  "card.newsHint": {
    ja: "台湾の記事だけに絞った検索結果",
    en: "Results limited to pages from Taiwan",
  },
  "card.threadsLabel": { ja: "Threads で見る", en: "See it on Threads" },
  "card.threadsHint": {
    ja: "台湾の人がいま書いている短い文",
    en: "Short posts people in Taiwan are writing now",
  },
  "card.contextLabel": { ja: "文の中での使われ方", en: "How it sits in a sentence" },
  "card.contextHint": {
    ja: "実際の文と対訳を並べて見る",
  ...
  "card.encounterLabels": { ja: "出会いやすい所", en: "Where you'll meet it" },
  "card.encKind.place": { ja: "場所", en: "Place" },
  "card.encKind.media": { ja: "媒体", en: "Media" },
  "card.encKind.situation": { ja: "状況", en: "Situation" },
  "card.encKind.emotion": { ja: "気持ち", en: "Feeling" },
  "card.encKind.time": { ja: "時刻", en: "Time" },
  "card.encKind.season": { ja: "季節", en: "Season" },
