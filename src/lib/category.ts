...
const EXACT: Record<string, CategoryKey> = {
  ...
  手: "body", 腳: "body", 脚: "body", 頭: "body", 髮: "body", 頭髮: "body",
  眼: "body", 眼睛: "body", 耳: "body", 耳朵: "body", 鼻: "body", 鼻子: "body",
  嘴: "body", 嘴巴: "body", 臉: "body", 舌: "body", 舌頭: "body", 牙: "body",
  牙齒: "body", 指: "body", 手指: "body", 腳趾: "body", 肩: "body", 肩膀: "body",
  膝: "body", 膝蓋: "body", 肚: "body", 肚子: "body", 背: "body", 胸: "body",
  腰: "body", 脖: "body", 脖子: "body", 手肘: "body", 手腕: "body", 手臂: "body",
  // 自然・空・水
  太陽: "sky", 月亮: "sky", 星星: "sky", 雲: "weather", 雨: "weather",
  風: "weather", 雪: "weather", 颱風: "weather", 台風: "weather",
  海: "water", 河: "water", 湖: "water", 水: "drink",
  山: "mountain",
  // 人・家族
  女朋友: "person", 男朋友: "person", 朋友: "person", 老師: "job", 學生: "person",
  醫生: "job", 護士: "job", 店員: "job", 司機: "job",
  爸爸: "family", 媽媽: "family", 哥哥: "family", 姐姐: "family",
  弟弟: "family", 妹妹: "family", 家人: "family",
};
...
const CONTAINS: Array<[RegExp, CategoryKey]> = [
  // テック・ガジェット
  [/(滑鼠|鍵盤|電腦|筆電|螢幕|手機|平板|耳機|喇叭|路由器|插頭|充電器|相機|行動電源|USB|手機架)/, "tech"],
  // 交通
